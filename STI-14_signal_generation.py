...
def signal_generation():
    ...
    def am_modulation(sign:np.ndarray, f_m:float, time:np.ndarray):
        ...
        modulates the amplitude of the signal function, modulation depth is equivalent to 1
        """
    ...
    def G_k(sign:np.ndarray, k:int):
        """
        factors the sample by standard prescribed value (this weighs each octave band)
        """
